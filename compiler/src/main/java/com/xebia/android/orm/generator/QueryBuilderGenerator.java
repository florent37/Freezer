    ...
    public TypeSpec generate() {
        ...
        protected List<TypeSpec> generateSelectors() {
                ...
                typeSpecs.add(TypeSpec.classBuilder(Constants.SELECTOR_NUMBER)
                        ...
                        .addField(TypeVariableName.get("Q1"), "queryBuilder", Modifier.PUBLIC)
                        .addField(TypeName.get(String.class), "column", Modifier.PUBLIC)
                ...
                typeSpecs.add(TypeSpec.classBuilder(Constants.SELECTOR_STRING)
                        ...
                        .addField(TypeVariableName.get("Q2"), "queryBuilder", Modifier.PUBLIC)
                        .addField(TypeName.get(String.class), "column")
                ...
                typeSpecs.add(TypeSpec.classBuilder(Constants.SELECTOR_BOOLEAN)
                        ...
                        .addField(TypeVariableName.get("Q3"), "queryBuilder", Modifier.PUBLIC)
                        .addField(TypeName.get(String.class), "column")
