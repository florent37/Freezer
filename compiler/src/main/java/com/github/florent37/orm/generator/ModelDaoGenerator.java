...
public class ModelDaoGenerator {
    ...
    public ModelDaoGenerator(Element element) {
        this.modelName = com.github.florent37.orm.ProcessUtils.getObjectName(element);
        this.modelPackage = com.github.florent37.orm.ProcessUtils.getObjectPackage(element);

        this.modelClassName = TypeName.get(element.asType());
        this.modelCursorHelperClassName = com.github.florent37.orm.ProcessUtils.getCursorHelper(element);

        this.TABLE_NAME = com.github.florent37.orm.ProcessUtils.getTableName(element);

        this.queryBuilderClassName = com.github.florent37.orm.ProcessUtils.getQueryBuilder(element);
        this.enumColums = com.github.florent37.orm.ProcessUtils.getElementEnumColumn(element);

        this.fields = com.github.florent37.orm.ProcessUtils.getPrimitiveFields(element);
        this.otherClassFields = com.github.florent37.orm.ProcessUtils.getNonPrimitiveClassFields(element);
    }
    ...
    public ModelDaoGenerator generate() {
        ...
        TypeName listObjectsClassName = com.github.florent37.orm.ProcessUtils.listOf(modelClassName);

        this.queryBuilder = TypeSpec.classBuilder(com.github.florent37.orm.ProcessUtils.getQueryBuilderName(modelName)) //UserDAOQueryBuilder
                .addModifiers(Modifier.PUBLIC)

                .addField(ClassName.get(StringBuilder.class), "queryBuilder")
                .addField(ClassName.get(StringBuilder.class), "orderBuilder")
                .addField(com.github.florent37.orm.ProcessUtils.listOf(String.class), "args")
                .addField(com.github.florent37.orm.ProcessUtils.listOf(String.class), "fromTables")
                .addField(com.github.florent37.orm.ProcessUtils.listOf(String.class), "fromTablesNames")
                .addField(com.github.florent37.orm.ProcessUtils.listOf(String.class), "fromTablesId")
                .addField(TypeName.BOOLEAN, "named")
                .addField(ClassName.get(com.github.florent37.orm.Constants.DAO_PACKAGE, com.github.florent37.orm.Constants.QUERY_LOGGER), "logger")
                ...
                .addMethod(MethodSpec.constructorBuilder()
                        ...
                        .addStatement("this.args = new $T()", com.github.florent37.orm.ProcessUtils.arraylistOf(String.class))
                        .addStatement("this.fromTables = new $T()", com.github.florent37.orm.ProcessUtils.arraylistOf(String.class))
                        .addStatement("this.fromTablesNames = new $T()", com.github.florent37.orm.ProcessUtils.arraylistOf(String.class))
                        .addStatement("this.fromTablesId = new $T()", com.github.florent37.orm.ProcessUtils.arraylistOf(String.class))
                        .build())

                .addMethod(MethodSpec.constructorBuilder()
                        .addModifiers(Modifier.PUBLIC)
                        .addParameter(TypeName.BOOLEAN, "named")
                        .addParameter(ClassName.get(com.github.florent37.orm.Constants.DAO_PACKAGE, com.github.florent37.orm.Constants.QUERY_LOGGER), "logger")
                        .addStatement("this()")
                ...
                .addMethod(MethodSpec.methodBuilder("sum")
                        ...
                        .addParameter(enumColums, "column")
                        .addModifiers(Modifier.PUBLIC)
                        .addStatement("$T db = $T.getInstance().open().getDatabase()", com.github.florent37.orm.Constants.databaseClassName, com.github.florent37.orm.Constants.daoClassName)
                        .addStatement("$T cursor = db.rawQuery($S + column.getName() + $S + constructQuery(), constructArgs())", com.github.florent37.orm.Constants.cursorClassName, String.format("select sum(%s.", TABLE_NAME), String.format(") from %s ", TABLE_NAME))
                        .addStatement("cursor.moveToNext()")
                        .addStatement("float value = cursor.getFloat(0)")

                        .addStatement("cursor.close()")
                        .addStatement("$T.getInstance().close()", com.github.florent37.orm.Constants.daoClassName)
                ...
                .addMethod(MethodSpec.methodBuilder("min")
                        ...
                        .addModifiers(Modifier.PUBLIC)
                        .addStatement("$T db = $T.getInstance().open().getDatabase()", com.github.florent37.orm.Constants.databaseClassName, com.github.florent37.orm.Constants.daoClassName)
                        .addStatement("$T cursor = db.rawQuery($S + column.getName() + $S + constructQuery(), constructArgs())", com.github.florent37.orm.Constants.cursorClassName, String.format("select min(%s.", TABLE_NAME), String.format(") from %s ", TABLE_NAME))
                        .addStatement("cursor.moveToNext()")
                        .addStatement("float value = cursor.getFloat(0)")
                ...
                .addMethod(MethodSpec.methodBuilder("max")
                        ...
                        .addModifiers(Modifier.PUBLIC)
                        .addStatement("$T db = $T.getInstance().open().getDatabase()", com.github.florent37.orm.Constants.databaseClassName, com.github.florent37.orm.Constants.daoClassName)
                        .addStatement("$T cursor = db.rawQuery($S + column.getName() + $S + constructQuery(), constructArgs())", com.github.florent37.orm.Constants.cursorClassName, String.format("select max(%s.", TABLE_NAME), String.format(") from %s ", TABLE_NAME))
                        .addStatement("cursor.moveToNext()")
                        .addStatement("float value = cursor.getFloat(0)")
                ...
                .addMethod(MethodSpec.methodBuilder("average")
                        ...
                        .addModifiers(Modifier.PUBLIC)
                        .addStatement("$T db = $T.getInstance().open().getDatabase()", com.github.florent37.orm.Constants.databaseClassName, com.github.florent37.orm.Constants.daoClassName)
                        .addStatement("$T cursor = db.rawQuery($S + column.getName() + $S + constructQuery(), constructArgs())", com.github.florent37.orm.Constants.cursorClassName, String.format("select avg(%s.", TABLE_NAME), String.format(") from %s ", TABLE_NAME))
                        .addStatement("cursor.moveToNext()")
                        .addStatement("float value = cursor.getFloat(0)")
                ...
                .addMethod(MethodSpec.methodBuilder("count")
                        ...
                        .addModifiers(Modifier.PUBLIC)
                        .addStatement("$T db = $T.getInstance().open().getDatabase()", com.github.florent37.orm.Constants.databaseClassName, com.github.florent37.orm.Constants.daoClassName)
                        .addStatement("$T cursor = db.rawQuery($S + constructQuery(), constructArgs())", com.github.florent37.orm.Constants.cursorClassName, String.format("select count(distinct(%s.%s)) from %s ", TABLE_NAME, com.github.florent37.orm.Constants.FIELD_ID, TABLE_NAME))
                        .addStatement("cursor.moveToNext()")
                ...
                .addMethod(MethodSpec.methodBuilder("getTableId")
                        ...
                        .addStatement("else{ tableId = $S + fromTables.size(); fromTablesId.add(tableId); fromTables.add(tableName + \" \" + tableId); fromTablesNames.add(tableName); }", com.github.florent37.orm.Constants.QUERY_TABLE_VARIABLE)
                ...
                .addMethod(MethodSpec.methodBuilder("query")
                        ...
                        .addParameter(com.github.florent37.orm.ProcessUtils.listOf(String.class), "args")
                        .addStatement("args.addAll(this.args)")
                        .addStatement("queryBuilder.append(\" AND \").append(joinTable).append(\".\").append(joinIdFrom).append(\"  = \").append(fromTable).append(\".$L\")", com.github.florent37.orm.Constants.FIELD_ID)
                        .addStatement("queryBuilder.append(\" AND \").append(joinTable).append(\".\").append(joinIdTo).append(\"  = \").append(table).append(\".$L\")", com.github.florent37.orm.Constants.FIELD_ID)
                        .addStatement("queryBuilder.append(\" AND \").append(joinTable).append(\".$L  = '\").append(variable).append(\"'\")", com.github.florent37.orm.Constants.FIELD_NAME)
                        .addStatement("return queryBuilder.toString().replace($S,table)", com.github.florent37.orm.Constants.QUERY_NAMED)
                        .build())
                ...
                .addMethod(MethodSpec.methodBuilder("execute")
                        ...
                        .addStatement("$T cursor = db.rawQuery(query, args)", com.github.florent37.orm.Constants.cursorClassName)
        ...
        this.dao = TypeSpec.classBuilder(com.github.florent37.orm.ProcessUtils.getModelDaoName(modelName)) //UserDAO
                .addModifiers(Modifier.PUBLIC)
                ...
                .addMethod(MethodSpec.methodBuilder("add")
                        ...
                        .addModifiers(Modifier.PUBLIC)
                        .addStatement("$T database = $T.getInstance().open().getDatabase()", com.github.florent37.orm.Constants.databaseClassName, com.github.florent37.orm.Constants.daoClassName)
                        .addStatement("$T.insert(database,object)", modelCursorHelperClassName)
                        .addStatement("$T.getInstance().close()", com.github.florent37.orm.Constants.daoClassName)
                        .addStatement("return object.$L", com.github.florent37.orm.Constants.FIELD_ID)
                        .build())

                .addMethod(MethodSpec.methodBuilder("add")
                        .addParameter(com.github.florent37.orm.ProcessUtils.listOf(modelClassName), "objects")
                        .addModifiers(Modifier.PUBLIC)
                ...
                .addMethod(MethodSpec.methodBuilder("delete")
                        ...
                        .addStatement("$T.getInstance().open().getDatabase().delete($S, $S, new String[]{String.valueOf(object.$L)})", com.github.florent37.orm.Constants.daoClassName, TABLE_NAME, "_id = ?", com.github.florent37.orm.Constants.FIELD_ID)
                        .addStatement("$T.getInstance().close()", com.github.florent37.orm.Constants.daoClassName)
                        .build())
                ...
                .addMethod(MethodSpec.methodBuilder("deleteAll")
                        .addModifiers(Modifier.PUBLIC)
                        .returns(TypeName.VOID)
                        .addStatement("$T.getInstance().open().getDatabase().execSQL($S)", com.github.florent37.orm.Constants.daoClassName, "delete from " + TABLE_NAME)
                        .addStatement("$T.getInstance().close()", com.github.florent37.orm.Constants.daoClassName)
                        .build())
                ...
                .addMethod(MethodSpec.methodBuilder("count")
                        ...
                        .returns(TypeName.INT)
                        .addStatement("$T db = $T.getInstance().open().getDatabase()", com.github.florent37.orm.Constants.databaseClassName, com.github.florent37.orm.Constants.daoClassName)
                        .addStatement("$T cursor = db.rawQuery($S,null)", com.github.florent37.orm.Constants.cursorClassName, "select count(*) from " + TABLE_NAME)
    ...
    protected List<MethodSpec> generateQueryMethods() {
        ...
        for (VariableElement variableElement : otherClassFields) {
            ...
            String JOINTABLE = com.github.florent37.orm.ProcessUtils.getTableName(modelName) + "_" + com.github.florent37.orm.ProcessUtils.getTableName(variableElement);

            methodSpecs.add(MethodSpec.methodBuilder(variableElement.getSimpleName().toString())
                    .returns(queryBuilderClassName)
                    .addModifiers(Modifier.PUBLIC)
                    .addParameter(com.github.florent37.orm.ProcessUtils.getFieldQueryBuilderClass(variableElement), "query")
                    .addStatement("queryBuilder.append('(').append(query.query($S,getTableId($S),$S,$S,getTableId($S),$S,args)).append(')')", TABLE_NAME, JOINTABLE, com.github.florent37.orm.ProcessUtils.getKeyName(modelName), com.github.florent37.orm.ProcessUtils.getKeyName(variableElement), com.github.florent37.orm.ProcessUtils.getTableName(variableElement), com.github.florent37.orm.ProcessUtils.getObjectName(variableElement))
                    .addStatement("return this")
                    .build());
        }
    ...
    protected TypeName getSelectorName(Element element) {
        ...
        if (TypeName.INT.equals(typeName) || TypeName.LONG.equals(typeName) || TypeName.FLOAT.equals(typeName) )
            return ClassName.bestGuess(queryBuilderClassName + "." + com.github.florent37.orm.Constants.SELECTOR_NUMBER);
        if (TypeName.BOOLEAN.equals(typeName))
            return ClassName.bestGuess(queryBuilderClassName + "." + com.github.florent37.orm.Constants.SELECTOR_BOOLEAN);
        if (TypeName.get(String.class).equals(typeName))
            return ClassName.bestGuess(queryBuilderClassName + "." + com.github.florent37.orm.Constants.SELECTOR_STRING);
    ...
    protected String generateCreationString() {
        ...
        for (VariableElement variableElement : otherClassFields) {
            String table = TABLE_NAME + "_" + com.github.florent37.orm.ProcessUtils.getTableName(variableElement);
            if (!addedTables.contains(table)) {
                stringBuilder
                        ...
                        .append(com.github.florent37.orm.ProcessUtils.getKeyName(modelName)).append(" integer, ")
                        .append(com.github.florent37.orm.ProcessUtils.getKeyName(variableElement)).append(" integer, ")
                        .append(com.github.florent37.orm.Constants.FIELD_NAME).append(" text )")
                        .append('"');
    ...
    protected List<TypeSpec> generateSelectors() {
        ...
        typeSpecs.add(TypeSpec.classBuilder(com.github.florent37.orm.Constants.SELECTOR_NUMBER)
                .addModifiers(Modifier.PUBLIC, Modifier.STATIC)
        ...
        typeSpecs.add(TypeSpec.classBuilder(com.github.florent37.orm.Constants.SELECTOR_STRING)
                .addModifiers(Modifier.PUBLIC, Modifier.STATIC)
                .addField(queryBuilderClassName, "queryBuilder")
                .addField(enumColums, "column")
        ...
        typeSpecs.add(TypeSpec.classBuilder(com.github.florent37.orm.Constants.SELECTOR_BOOLEAN)
                .addModifiers(Modifier.PUBLIC, Modifier.STATIC)
                .addField(queryBuilderClassName, "queryBuilder")
                .addField(enumColums, "column")
    ...
    protected String generateTableCreate() {
        ...
        for (int i = 0; i < fields.size(); ++i) {
            ...
            if (!com.github.florent37.orm.Constants.FIELD_ID.equals(variableElement.getSimpleName().toString())) {
                stringBuilder
                        .append(variableElement.getSimpleName())
                        .append(" ")
                        .append(com.github.florent37.orm.ProcessUtils.getFieldTableType(variableElement));
                if (i < fields.size() - 1)
